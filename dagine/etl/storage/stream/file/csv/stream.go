...
func (s *Stream) Rows(conf *jsonutil.JSON) (rows file.Rows, err error) {
...
func NewRows(f *os.File, c *jsonutil.JSON) (file.Rows, error) {
	var conf *InConfig
	var err error
...
func NewWriter(f *os.File, c *jsonutil.JSON) (file.StreamWriter, error) {
	var conf *OutConfig
	var err error
